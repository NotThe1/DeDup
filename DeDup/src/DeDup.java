...
public class DeDup {
	...
	private void doRemoveFolder(DefaultListModel<String> listModel) {
		
	}//doAddFolder
	
	private void doClearFolders(DefaultListModel<String> listModel) {
		listModel.clear();
	}//doAddFolder
	...
	private void initialize() {
		...
		panelTargets1.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), "Folders to Search", TitledBorder.CENTER, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
		...
		JButton btnTargetRemove = new JButton("REMOVE");
		...
		panelSkip1.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), "Folders to Skip", TitledBorder.CENTER, TitledBorder.ABOVE_TOP, null, null));
		...
		JButton btnSkipRemove = new JButton("REMOVE");
	 ...
	 class AdapterDeDup implements ActionListener {
		...
		public void actionPerformed(ActionEvent ActionEvent) {
			...
			case BTN_TARGET_REMOVE:
				log.infof("Action Command = %s%n", ActionEvent.getActionCommand());
				doRemoveFolder(targetListModel);
				break;
			case BTN_TARGET_CLEAR:
				log.infof("Action Command = %s%n", ActionEvent.getActionCommand());
				doClearFolders(targetListModel);
				break;
			case BTN_SKIP_ADD:
				log.infof("Action Command = %s%n", ActionEvent.getActionCommand());
			...
			case BTN_SKIP_REMOVE:
				log.infof("Action Command = %s%n", ActionEvent.getActionCommand());
				doRemoveFolder(skipListModel);
				break;
			case BTN_SKIP_CLEAR:
				log.infof("Action Command = %s%n", ActionEvent.getActionCommand());
				doClearFolders(skipListModel);
				break;
			 default:
